...
//    final List<Map<String, dynamic>> result4 = await db.rawQuery(_queryinsert4);
  ...
  Future<int> InserirQuestionarioCqMidia({Map<String, dynamic> dadosArquivo}) async {
    final Database db = await getDatabase();
  ...
  Future<int> deletarQuestionarioCqMidia({String codigo_empresa = "", int codigo_programacao = 0, int item_checklist = 0, int item_anexo = 0}) async {
    final Database db = await getDatabase();
  ...
  Future<int> updateTituloQuestionarioCqMidia({String titulo_arquivo = "", String codigo_empresa = "", int codigo_programacao = 0, int item_checklist = 0, int item_anexo = 0}) async {
    final Database db = await getDatabase();
